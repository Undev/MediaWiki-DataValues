...
( function( vp, dv, $, QUnit, undefined ) {
	...
	/**
	 * Constructor for creating a test object holding tests for the NumberParser.
	 *
	 * @constructor
	 * @extends dv.tests.ValueParserTest
	 * @since 0.1
	 */
	vp.tests.NumberParserTest = vp.util.inherit( PARENT, {

		/**
		 * @see vp.tests.ValueParserTest.getObject
		 */
		getObject: function() {
			return vp.NumberParser;
		},
	...
	var test = new vp.tests.NumberParserTest();

	test.runTests( 'valueParsers.NumberParser' );
